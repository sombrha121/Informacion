...
@section('page-title', 'Registrar Nuevo Tratamiento')

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><i class="bi bi-capsule"></i> Formulario de Nuevo Tratamiento</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('tratamientos.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nombre_tratamiento') is-invalid @enderror" 
                       id="nombre_tratamiento" name="nombre_tratamiento" value="{{ old('nombre_tratamiento') }}" required>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('medicamentos') is-invalid @enderror" 
                          id="medicamentos" name="medicamentos" rows="3" 
                          placeholder="Ejemplo: Paracetamol 500mg cada 8 horas">{{ old('medicamentos') }}</textarea>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('indicaciones') is-invalid @enderror" 
                          id="indicaciones" name="indicaciones" rows="3">{{ old('indicaciones') }}</textarea>
